...
namespace MissionPlanner
{
    public partial class MainV3_pilot : Form
    {
        ...
        /// </summary>
        public static MainV3_pilot instance = null;
        ...
        public void updateLayout(object sender, EventArgs e)
        {
            ...
            if (MainV3_pilot.instance.FlightData != null)
            {
                TabControl t = MainV3_pilot.instance.FlightData.tabControlactions;
        ...
        public void switchicons(menuicons icons)
        {
            ...
            ////MenuFlightLog.ForeColor = ThemeManager.TextColor;
            //MenuMain.ForeColor = ThemeManager.TextColor;
            //MenuLogin.ForeColor = ThemeManager.TextColor;
        }
        ...
        {
            SidePanel.Width = but_flightPlan.Width;
            SidePanel.Left = but_flightPlan.Left;
            MyView.ShowScreen("FlightPlanner");
        }
        ...
        private void MainV3_pilot_Load(object sender, EventArgs e)
        {
